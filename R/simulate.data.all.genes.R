simulate.data.all.genes <- function(obs.genome,
  ...
  if(is.null(obs.codon.parms))
  {
    warning('obs.codon.parms for simulating dataset are not included. Using init.codon.parms.')
    obs.codon.parms <- init.codon.parms
  }
